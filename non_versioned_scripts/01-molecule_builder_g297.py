...
#       b = float(sys.argv[2])
    ...
    lines_in_route = 5 # for the g297, it is 4

    molecule_prefix = 'g297'
    molecule_id = 1147

    os.system('rm -f *.coor')

    database = 'g2-97_b3lyp_small.txt'
                 
                  # g2-97_b3lyp_neut.txt <- check web prefix on this one (up top)
                  # g2-97_b3lyp_small.txt 
                  # g2-97_b3lyp_anion.txt
                  # g2-97_b3lyp_cation.txt
                  # g2-97_b3lyp_aux.txt
