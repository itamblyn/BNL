...
#       b = float(sys.argv[2])
       ...
       # Tell the user what they need to give
        ...
        sys.exit(0)
    print 'Current configuation is based on the g399 test set.'
    ...
    lines_in_route = 5 # for the g399, it is 5 

    molecule_prefix = 'g399'
    molecule_id = 1000

    os.system('rm -f *.coor')

    get_coordinates = commands.getoutput('rm -f g3-3_b3lyp.txt')
    get_coordinates = commands.getoutput('wget http://www.cse.anl.gov/OldCHMwebsiteContent/compmat/g3-3_b3lyp.txt')

    os.system('sed s/LINK1/link1/g g3-3_b3lyp.txt > test_set.clean')
